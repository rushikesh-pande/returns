package com.order.returns.monitoring.aspect;
...
public class MonitoringAspect {
    ...
    public Object monitorControllerMethod(ProceedingJoinPoint pjp) throws Throwable {
        ...
        String metricName = "returns.controller.duration";
        ...
        try {
            ...
            Counter.builder("returns.controller.errors")
                   .tag("service", "returns")
                   .tag("class",  className)
    ...
    public Object monitorServiceMethod(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            meterRegistry.timer("returns.service.duration",
                    "service", "returns",
                    "class",  className,
                    "method", methodName)
